...
The bundled `nudge` skill is the agent-facing rule reference. It includes
focused references for writing rules, debugging noisy matches, validation, CI,
local setup, hook responses, and learned incident notes.
