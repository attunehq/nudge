  ...
  <white>Basic Syntax:</white>
    <yellow>content:</yellow>
      <yellow>- kind: SyntaxTree</yellow>
        <yellow>language: javascript</yellow>        <dim># Required: see supported languages below</dim>
        <yellow>query: |</yellow>
          <yellow>(call_expression</yellow>
            <yellow>function: (identifier) @fn_name)</yellow>
